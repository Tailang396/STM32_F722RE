...
void LCD_ShowFloatPositiveNum(uint16_t x, uint16_t y, float num, uint8_t len, uint8_t decimal, uint16_t fc, uint16_t bc, uint8_t sizey);	// 显示正的浮点数
...
//
// LCD_Fill(0,0,120,140,BLUE);
// LCD_Fill(120,0,240,140,GREEN);
// LCD_ShowString(20,0,"Hello Wrold!",RED,BLUE,16,0);
// HAL_Delay(1000);
// LCD_ShowChinese(20,200,"你",BLUE,RED,16,0);
// HAL_Delay(1000);
// LCD_ShowChinese(36,200,"你",WHITE,RED,16,0);
